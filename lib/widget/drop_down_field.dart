          ...
          builder: (FormFieldState<String> field) {
            ...
            final InputDecoration effectiveDecoration = InputDecoration(
                ...
                suffixIcon: IconButton(
                    icon: !state._showdropdown
                        ? Icon(Icons.arrow_drop_down,
                            size: 30.0, color: HexColor(BLACK_COLOR))
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        ...
                        child: InkWell(
                          ...
                          child: Icon(
                            Icons.cancel,
                            color: state._effectiveController.text.isNotEmpty
                                ? HexColor(BLACK_COLOR)
                                : Colors.grey,
                          ),
                          onTap: () {
                            if (!enabled) return;
                    ...
                    : Container(
                        ...
                        height: items.isNotEmpty
                            ...
                            : itemsVisibleInDropdown *
                                12.0, //limit to default 3 items in dropdownlist view and then remaining scrolls
  ...
  void _handleControllerChanged() {
    ...
    if (_effectiveController.text.isEmpty) {
      ...
      setState(() {
        _isSearching = true;
        _searchText = _effectiveController.text;
        if (!_alreadySearch) _showdropdown = true;
      });
    }
  }
}
